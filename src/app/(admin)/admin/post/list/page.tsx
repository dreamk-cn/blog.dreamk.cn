...
export default function Posts() {
  ...
  return (
    <AdminListLayout error={error}>
      ...
      <AdminListBody>
        <AdminListTable aria-label="文章列表" className="rounded-lg">
                  ...
                  <Table.Cell>
                    {item.category ? (
                      <Chip
                        ...
                        size="sm"
                        variant="soft"
                        color={getTagColor(item.category.name)}
                      >
                      ...
                      <span className="text-default-400 text-text-muted">
                        -
                      </span>
                    )}
                  </Table.Cell>
                      ...
                      <div className="flex flex-wrap gap-1">
                        {item.tags.map((t) => (
                          <Chip
                            ...
                            color="accent"
                          >
                            <Chip.Label className="text-text-base">
                              {t.name}
                            </Chip.Label>
                          </Chip>
                        ))}
                  ...
                  <Table.Cell>
                    <div className="flex justify-center gap-2">
                      <Button
                        ...
                        onPress={() =>
                          router.push(
                            `/admin/post/create?type=edit&id=${item.id}`,
                          )
                        }
                      >
                        编辑
