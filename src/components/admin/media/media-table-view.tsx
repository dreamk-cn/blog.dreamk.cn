...
import { AdminListTable, adminTableHeaderClassName } from "@/components/admin/admin-list-layout";
...
export function MediaTableView({
  ...
  return (
    <AdminListTable aria-label="文件列表" className="rounded-lg bg-background">
