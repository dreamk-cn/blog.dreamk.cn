...
const rawEnvSchema = z
  .object({
    ...
    FRIEND_LINK_APPLY_RATE_MAX: z.string().optional(),
    FRIEND_LINK_APPLY_RATE_WINDOW_SEC: z.string().optional(),
...
function buildEnv(raw: RawEnv) {
  ...
  const rateLimits = {
    ...
    FRIEND_LINK_APPLY_RATE_MAX: readOptionalInt(raw.FRIEND_LINK_APPLY_RATE_MAX, 3),
    FRIEND_LINK_APPLY_RATE_WINDOW_SEC: readOptionalInt(raw.FRIEND_LINK_APPLY_RATE_WINDOW_SEC, 3600, 1),
